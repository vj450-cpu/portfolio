...
function Projects() {
  const projects = [
    { title: "FarmSmart Analytics", techStack: ["React", "Node.js", "Predictive Analytics"], desc: "Built responsive analytics dashboard with predictive insights and interactive visualizations for agricultural market analysis.", link: "https://github.com/vj450-cpu/FarmSmart", img: import.meta.env.BASE_URL + "img/farmsmart.png" },
    { title: "Secured Enterprise Chat", techStack: ["JavaScript", "AES-256", "WebSockets"], desc: "Engineered a real-time, end-to-end encrypted communication platform achieving sub-50ms latency with SFA Authentication.", link: "https://github.com/vj450-cpu/Secured-Chat-system", img: import.meta.env.BASE_URL + "img/chat.png" },
    { title: "GoBeam Load Balancer", techStack: ["Go", "Docker", "Systems"], desc: "Developed a high-throughput Layer 7 load balancer handling 10k+ concurrent connections with built-in health tracking metrics.", link: "https://github.com/vj450-cpu/GoBeam", img: import.meta.env.BASE_URL + "img/gobeam.png" },
